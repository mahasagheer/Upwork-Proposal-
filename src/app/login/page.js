          ...
          <div className="p-8">
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 rounded border-muted-foreground/30 text-primary focus:ring-primary/50"
                  />
              ...
              <div className="space-y-4">
                ...
                <button
                  formAction={signup}
                  className="w-full flex items-center justify-center px-6 py-3 rounded-lg border border-primary/30 bg-background text-primary font-medium hover:bg-primary/10 hover:border-primary/50 transition-colors duration-300"
                >
                  Create new account
                </button>
              </div>
